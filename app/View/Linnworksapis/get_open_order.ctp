                    ...
                    <div class="row">
                        <div class="col-lg-12">
							<table class="table table-bordered table-striped dataTable">
								...
								<td>
								<?php echo number_format($checkproduct->changeCurrency($standerdOne->TotalsInfo->TotalCharge, $standerdOne->TotalsInfo->Currency), 2, '.' ,''); ?>
								</td>
								<td>
								<?php echo $standerdOne->TotalsInfo->TotalCharge; ?>
								</td>
								<td>
